...
function unlockMatches() {
	chrome.tabs.executeScript(null, 
		{code:"document.body.innerHTML = document.body.innerHTML.replace('Upgrade to Gold to see people who already liked you.', 'Enjoy the magic of TindrUnblur 🔥')"});
